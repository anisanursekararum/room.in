...
<head>
  ...
  <title>Room.In - @yield('title')</title>
  ...
  <link href="{{url('theme-sbadmin/css/sb-admin-2.min.css')}}" rel="stylesheet">
...
<body class="bg-gradient-primary">
  ...
  <script src="{{url('theme-sbadmin/js/sb-admin-2.min.js')}}"></script>
